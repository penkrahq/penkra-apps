...
public struct IOSGridPaddingOverlayControl: View {
  public init() {}
  public var body: some View {
    ZStack(alignment: .topLeading) {
      ZStack(alignment: .topLeading) {
        ...
        Rectangle().fill(Color(red: 0.671, green: 0.804, blue: 0.937, opacity: 1)).opacity(1).frame(width: 20, height: 10, alignment: .topLeading).position(x: 17, y: 14)
