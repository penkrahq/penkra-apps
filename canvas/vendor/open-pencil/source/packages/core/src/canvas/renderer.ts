...
export class SkiaRenderer {
  ...
  declare linearBurnBlender: import('canvaskit-wasm').Blender
  ...
  pencilShaderRenderCanvas: Canvas | null = null
  ...
  subtreeCullBounds = new Map<string, VisualBounds>()
  subtreeNodeCounts = new Map<string, number>()
  subtreeCullBoundsGraph: SceneGraph | null = null
  ...
  declare drawFrameTitles: (canvas: Canvas, graph: SceneGraph, selectedIds: Set<string>) => void
  declare renderNode: (
    canvas: Canvas,
    graph: SceneGraph,
    nodeId: string,
