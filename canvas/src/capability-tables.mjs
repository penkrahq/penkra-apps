...
function mobileCandidateRows(platform, includesAlignItems) {
  ...
  return {
    ...Object.fromEntries([
      ...
      "properties.fill.gradient.linear.transformed", "properties.fill.gradient.radial.transformed", "properties.icon", "properties.layoutPosition", "properties.library", "properties.weight",
