...
export const MOBILE_NONTEXT_MATRIX = Object.freeze({
  ...
  "properties.gridTemplateColumns": both("layout-constraints", ["iphone-3x", "ipad-2x", "android-420dpi", "android-320dpi"], ["android-grid-after-420.png", "android-grid-after-320.png"]),
  ...
  "properties.layout": both("layout-constraints", ["iphone-3x", "ipad-2x", "android-420dpi", "android-320dpi"], ["*-independent-gaps.png", "*-linear-padding.png"]),
  "properties.layoutPosition": both("layout-constraints", ["iphone-3x", "ipad-2x", "android-420dpi", "android-320dpi"]),
